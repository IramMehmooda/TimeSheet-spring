...
public class Task {
	...
	@JoinTable(name="task_employee", joinColumns= {@JoinColumn(name="task_employee")}, inverseJoinColumns= {@JoinColumn(name="employee_id")})
	...
	public String toString() {
		return "Task [id=" + id + ", assignedEmployees=" + assignedEmployees + ", manager=" + manager + ", completed="
