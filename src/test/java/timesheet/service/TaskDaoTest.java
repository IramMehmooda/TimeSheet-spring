...
import timesheet.service.Service.DomainAwareBase;
...
public class TaskDaoTest extends DomainAwareBase {
    ...
    public void testUpdate() {
        ...
        // update task
        task.setDescription("Requirement Gathering");
        taskDao.update(task);

        Task found = taskDao.find(task.getId());
        assertEquals("Requirement Gathering", found.getDescription());
    }
    ...
    private Task newSpringTask() {
        ...
        return new Task("Validating Data", bob, steve, woz);
    }
